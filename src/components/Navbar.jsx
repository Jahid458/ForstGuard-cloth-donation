    ...
    <div className="navbar bg-base-100 container mx-auto">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <NavLink  className={({ isActive}) => `${isActive?" btn bg-sky-500 text-white":"btn"}` }
            to="/donationcampaign">Donation</NavLink>
          <NavLink  className={({ isActive}) => `${isActive?" btn bg-sky-500 text-white":"btn "}` }
            to="/help">How To Help</NavLink>
          <NavLink  className={({ isActive}) => `${isActive?" btn bg-sky-500 text-white":"btn"}` }
      ...
      <div className="navbar-end gap-3">
        {
          user ? <div className="flex">
            <img src={user?.photoURL} alt="" className="w-12 rounded-[50%] border-4 border-sky-500" />

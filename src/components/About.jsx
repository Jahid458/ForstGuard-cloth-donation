...
<div className="hero bg-sky-200 min-h-[300px]">
  <div className="hero-content flex-col lg:flex-row-reverse ">
    <img
      src="https://img.freepik.com/free-vector/flat-illustration-clothing-donation-concept_52683-55515.jpg?t=st=1732174266~exp=1732177866~hmac=dc36012aa6ab3bff74e4cee3a2f0c9d335d43d9cade4cfef0fb902e4877ed61a&w=740"
      className="rounded-lg shadow-2xl h-[500px] w-[700px] " />
    <div>
